    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="course_groups", to="account.employeeprofile"
                    ),
                ),
                (
                    "company",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        default="courses/defaults/default_thumbnail.jpg",
                        help_text="Upload a thumbnail image for this course (400x300px). Leave empty for default.",
                        null=True,
                        upload_to=courses.models.course_thumbnail_path,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "company_course_group",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="employee_assignments",
                        to="courses.companycoursegroup",
                    ),
                ),
                (
                    "course",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "time_limit_minutes",
                    models.IntegerField(
                        default=30, help_text="Time limit in minutes (0 for no limit)"
                    ),
                ),
                (
                    "max_attempts",
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        to="courses.employeecourseassignment",
                    ),
                ),
            ],
            options={"verbose_name_plural": "Employee Course Progress",},
        ),
        migrations.AddField(
            model_name="course",
            name="category",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="assigned_courses",
                through="courses.CompanyCourseAssignment",
                to="account.company",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="courses",
            field=models.ManyToManyField(
                blank=True, related_name="assigned_groups", to="courses.course"
            ),
        ),
        migrations.AddField(
            model_name="companycoursegroup",
        ...
        migrations.CreateModel(
            ...
            options={"unique_together": {("employee", "course")},},
        ),
        migrations.AlterUniqueTogether(
            name="companycourseassignment", unique_together={("company", "course")},
        ),
    ]
